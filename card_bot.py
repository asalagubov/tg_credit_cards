...
bot = TeleBot(token='5448312246:AAEOwx8jYmxXYHrGzVIr7Bnlm5bxyUGAaok', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет {0.first_name}! Меня зовут Картик, я умею генерировать номер тестовой банковской карты🛎 \nВыбери тип карты:'.format(message.from_user)
